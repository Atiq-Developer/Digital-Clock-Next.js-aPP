...
export default function DigitalClock() {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      <Card className="p-8 shadow-lg rounded-2xl bg-black border-[#44f2ef] ">
        <div className="flex flex-col items-center justify-center">
          {/* Header with title */}
          <div className="text-2xl font-bold tracking-tight text-[#37faf7] ">
            Digital Clock
          </div>
          {/* Description */}
          <div className="text-sm text-[#44f2ef] dark:text-gray-400 mb-4">
            Display current time in hours, minutes, and seconds.
          </div>
          {/* Display the formatted time */}
          <div className="text-6xl font-bold tracking-tight text-[#44f2ef]">
            {formattedTime}
          </div>
